...
public class DebugWindow : EditorWindow
{
	...
	readonly static Dictionary<string, string> commandDictionary = new () { { "help", "Shows the list of available commands." }, };
		...
		if (Button("Search", Width(100), Height(25)))
		{
			...
			switch (guids.Length)
			{
				...
				case > 1:
					...
					int pingExact = EditorUtility.DisplayDialogComplex("Multiple Assets Found", "More than one asset found. Would you like to ping all found assets or only the exact match (if found)?", "Exact Match", "All Assets", "Cancel");
